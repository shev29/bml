        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu"> 
                ...
                <li class="nav-item"> <a class="nav-link"   href="preadd_ckhusus.php"  >Khusus</a></li> 
           ...
           <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#krw" aria-expanded="false" aria-controls="icons">
              <i class="icon-contract menu-icon"></i>
              <span class="menu-title">Leave Karawang</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="krw">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="leave_karawang.php" >Approval Karawang</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
			  ...
			  <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="lahir_cuti.php">Lahir Cuti Manual</a></li>
              </ul>      
			  <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="import/upload.php">Import </a></li>
                <li class="nav-item"> <a class="nav-link" href="data_user.php"> Data User </a></li> 
                <li class="nav-item"> <a class="nav-link" href="courier_user.php"> Courier System </a></li> 
              </ul>
            </div>
          </li>
           <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#yo" aria-expanded="false" aria-controls="icons">
              <i class="icon-contract menu-icon"></i>
              <span class="menu-title">Attendance</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="yo">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="attendance/abnormal_report.php" target='_blank'>Abnormal (Daliy)</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
