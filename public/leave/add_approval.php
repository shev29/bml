...
if ($result->num_rows > 0) {
  ...
  ?>
                  <form class="forms-sample" method='post' action='post_app.php'>
                      
                      
                     <div class="form-group row">
                      <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Nama</label>
                      <div class="col-sm-9">
                                              <select name='nikuser' class="js-example-basic-multiple w-100">  
					...
					include "assets/configure/koneksi.php";   
					 ...
					 $sqlc1 = "SELECT  `id_user`, `nama_lengkap`, `nik`, `hire_date`, `email`, `email2`, `username`, `password`, `kode_loc`, `kode_dep`, `kode_section`,
					        `title`, `level`, `level_akses`, `token`, `exp_token`, `status_aktif`, `ket`, `ket2` FROM `user` ORDER BY nama_lengkap ASC";
