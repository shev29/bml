...
$update = "UPDATE tr_cuti SET nik_approve1 = '$nik_check1', status_approve1 = '1',`tgl_approve1` = NOW() WHERE id_trcuti=$id";
...
// Email Notification
	...
	(select nama_lengkap from user where nik=approve_1)as nm_approve1, 
...
if ($resultemailz->num_rows > 0) {
  ...
  while($rowemailz = $resultemailz->fetch_assoc()) {
	  ...
	  $nm_approve1 = $rowemailz['nm_approve1']; 
...
$bodys.="<table border='0'>";
	$bodys.="<tr><td colspan='3'>Dear $nama_pemohon  </td></tr> 
			...
			<tr><td>Superior / Atasan </td><td>: $nm_approve1</td><td>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			</td></tr> 
			<tr><td>Level </td><td>: Apporve</td><td></td></tr> 
