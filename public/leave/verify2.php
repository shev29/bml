...
//error_reporting(0);
session_start();
 //http://bml-log.site/verify.php?id_trcuti=8&&user=ilham037&&token=3a8f002f18c6fe49f50ba1b1872b77b0
$idload = $_GET['id_trcuti'];
$sqlxx = "SELECT  id_trcuti,nik_check1 FROM `tr_cuti` WHERE status_approve1='1' and id_trcuti='$idload'";
 //var_dump($sqlxx);
 ...
 <!-- form -->
           <div class="row"> 
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <center><h4 class="card-title">Leave Approval 2</h4></center>
...
$warnaHeading = "#FF0000";
 ...
 if ($status_check1=='0')
   ...
   ?>               
                    ...
                    <tr><td>Checked Status</td><td>:</td><td> <?php echo $satus1;?></td><tr>
                    <tr><td>Detail Date</td><td>:</td><td> <?php echo  $detail_tanggal;?></td></tr> 
                    
                    <tr><td <a href='reject_mail.php?id=<?php echo $id_trcuti;?>'><label class="badge badge-danger">Reject</label> </a>					
					</td><td></td><td>  <a href='approve_app1.php?id=<?php echo $id_trcuti;?>&&nik_check1=<?php echo $nik_atasan;?>&&nik_pemohon=<?php echo $nikpm;?>'><label class="badge badge-warning">Approve</label> </a>
               </td></tr>
