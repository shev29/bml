...
$warnaHeading = "#FF0000";
  ...
  while($row = $result->fetch_assoc()) {
     ...
     $showexpcuti="<center><img src='images/tthinggas.png' width='60' height='20'>";
	  ...
	  $ket = $row['ket'];
 if ($tag==0){
	 $show_tag="<label class='badge badge-danger'>Already Used</label>";
 }
  else {
	 $show_tag="<label class='badge badge-success'>Available</label>";
 }
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				.DataTable( {
					...
					"aoColumns": [
					  { "bSortable": false },
					  null, { "bSortable": false },null, null, { "bSortable": false }, { "bSortable": false }, 
					  { "bSortable": false }
					],
					"aaSorting": [],
