...
<?php include "assets/template/navbar.php"; ?>
 ...
 <!-- form -->
   <a href="post_mcbersamas.php"><button type="button" class="btn btn-warning btn-rounded btn-fw">Process Cuti Bersama</button></a>
           <div class="row"> 
...
<?php
 include "assets/configure/koneksi.php"; 
  $sqlTRUNCATE = "TRUNCATE TABLE tr_cuti_samaran";
...
<table id="simple-table" class="table  table-bordered table-hover">
                  <thead>
                        <tr style='background: #35A9DB;color:#fff;font-weight:normal;'>
                          ...
                          <th>Saldo Cuti</th> 
                          <th>Total C Bersama</th> 
                          <th><center>Sisa</center></th>
                           <th><center>Tag2</center></th>
                        </tr>  
                      </thead>
<?php 
...
if($sisa_cuti < $total_cutibersama){
    
    $show_tcb=$sisa_cuti;
    
}
else{
    $show_tcb=$total_cutibersama;
}
$hasil_kurang =  $sisa_cuti-$show_tcb;
        echo"<tr>   <td>$no</td>
                              <td>$nik</td>
                              <td>$nama_lengkap</td>
                              <td>$nama_bersama</td>
    ...
    $sql_cts = "INSERT INTO `tr_cuti_samaran` 
 ...
 `tgl_apphrgamng`, `ket`, `ket2`,tag) VALUES
 (NULL, '$nik', 'CT12', '$now_date', '$expire_paslibur',
 '$expire_paslibur', '$expire_paslibur', '$show_tcb', '', 
 '$cuti_tahuns', '$nama_bersama', '', '0', '0000-00-00 00:00:00', '120000010',
 '1', '$expire_paslibur', '', '0', '$expire_paslibur', '120000010', '1', '$expire_paslibur', '122050008', '0', '$expire_paslibur', 
 '108000010', '1', '$expire_paslibur', '108000010', '1', '$expire_paslibur', '108000010', '1', '$expire_paslibur', '', '','$tag')";
  //var_dump($sql_cts);
