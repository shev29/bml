...
<?php   include "assets/configure/koneksi.php"; 
 ...
 $sql = "SELECT  `id_logtcuti`, `id_trcuti`, `nik_atasan`, `nama_atasan`, `field`, `kode_jcuti`, `tgl_pengajuan`,
                `detail_tanggal`, `total_hari`, `action`, `reason`, `nik_pemohon`, `nama_pemohon`, `ket` FROM `log_tcuti` order by id_trcuti DESC";
    //var_dump($sql);
  //var_dump($sql);
