...
include "assets/configure/koneksi.php";  
 ...
 <div class="row">
 <!-- form -->	<center><h4>FORM PENGAJUAN CUTI KEGUGURAN</h4><br></center>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method='post'  enctype="multipart/form-data" action='post_ctkgg.php'>
				  
				  <div class="form-group row">
                      <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Lama&nbsp;</label>
                      <div class="col-sm-7">
					  
						<input type='text' class="form-control" name='total_cuti' Readonly   value='45 Hari'>
						<input type='hidden' name='total_cuti' Readonly   value='45'>
                      </div>
                    </div>
                    <div class="form-group row">
			...
			<input type="file" name="file" id="fileToUpload"> </div>
                    ...
                    Dengan ini mohon untuk tidak masuk kerja karena:
					 ...
					 <div class="form-group">
                      ...
                      <input type='text'  class="form-control" readonly value='Keguguran kandungan' id="exampleTextarea1" name='alasan'> 
                    </div>
                    <input type="submit" class="btn btn-primary mr-2" name='upload' Value='Submit'> 
