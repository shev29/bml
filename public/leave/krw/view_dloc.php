 ...
 <!-- Aprroval Cuti -->
           <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title mb-0">DATA LOCATION</p>
                  <div class="table-responsive">
                     <table id="dynamic-table"  border="1" style='border: 1px solid #fff; font-family: sans-serif; color: #232323;  border-collapse: collapse;
                      ...
                      <tbody>
<?php
///$query = "WHERE cuti_lahir.nik='$niks'"
 $sql = "SELECT `id_loc`, `kode_loc`, `nama_loc`, `alias`, `alamat`, `ket` FROM `location` ORDER BY id_loc DESC";
...
$warnaHeading = "#FF0000";
  ...
  while($row = $result->fetch_assoc()) {
	...
	echo "<tr bgcolor='$warna'>
			<td>$no</td>
			<td><font style='font-size: 12px;'>$kode_loc </font></td> 
			<td><font style='font-size: 12px;'>$nama_loc </font></td>  
			<td><font style='font-size: 12px;'>$alias </font></td>  
			<td><font style='font-size: 10px;'>$alamat </font></td> 
			<td><center><a href='edit_loc.php?id_loc=$id_loc'><img src='images/edit_blue.svg' width='23' height='20'> </a></td> 
			";?>
 
			<td><center> 
			<a href="delete_loc.php?id_loc=<?php echo $id_loc;?>" onclick="alert('Yakin akan di hapus!')">
			<img src='images/deldb.png' width='23' height='20'>
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				.DataTable( {
					...
					"aoColumns": [
					  { "bSortable": false },
					   { "bSortable": false },null,{ "bSortable": false },  { "bSortable": false },  { "bSortable": false },  
					  { "bSortable": false }
					],
					"aaSorting": [],
