...
$id = $_GET['id'];
$nik_check1 = $_GET['nik_check1'];
$nik_pemohon = $_GET['nik_pemohon'];

//echo "ID nya $id";
 
$update = "UPDATE tr_cuti SET nik_check1 = '$nik_check1', status_check1 = '1',`tgl_check1` = NOW() WHERE id_trcuti=$id";
...
// Email Notification
	$sqlemail = "SELECT tr_cutimail.id_trcuti, nama_lengkap, 
	user.nik, email, email2, `status_notif`, nama_cuti,
	tr_cutimail.total_hari, tr_cutimail.alasan,detail_tanggal, 
 ...
 WHERE tr_cutimail.id_trcuti='$id' 
 limit 0,1";
...
if ($resultemailz->num_rows > 0) {
  ...
  while($rowemailz = $resultemailz->fetch_assoc()) {
	  ...
	  $nik_applev2 = $rowemailz['approve_1'];
...
$bodys.="<table border='0'>";
	$bodys.="<tr><td colspan='3'>Dear $nama_pemohon  </td></tr>
	        <tr><td colspan='3'>Your leave request has been approved.</td></tr>
			<tr><td colspan='3'>Request cuti anda telah disetujui.</td></tr>
			<tr><td>Supervisor / Atasan </td><td>: $nm_check1</td><td>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			</td></tr> 
			<tr><td>Level </td><td>:Checked</td><td></td></tr> 
			<tr><td>Leave Type / Jenis Cuti </td><td>: $nama_cuti</td><td></td></tr> 
			<tr><td>Tanggal </td><td>: $detail_tanggal</td><td></td></tr> 
 ...
 $sqlapp2 = "UPDATE `user` SET `exp_token` = DATE_ADD(NOW(), INTERVAL 2 DAY) WHERE nik='$nik_applev2'";
 if ($conn->query($sqlapp2) === TRUE) {
 ...
 //var_dump($sql);
   if ($conn->query($sql) === TRUE) {
    ...
    window.alert('You have successfully approved this request and the requestor will be notified.');
    window.location.href='getmail_lev2.php?id_b=$id';
    </script>"); 
}  /* else {
