 ...
 <!-- Aprroval Cuti -->
           <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title mb-0">DATA DEPARTMENT</p>
...
$sql = "SELECT `id_dep`, `kode_dep`, `nama_dep`, `ket` FROM `department` ORDER BY id_dep DESC";
...
$warnaHeading = "#FF0000";
  ...
  while($row = $result->fetch_assoc()) {
	...
	echo "<tr bgcolor='$warna'>
			...
			<td>$nama_dep </td>  
			<td>$ket </td> 
			<td><center><a href='edit_dep.php?id_dep=$id_dep'><img src='images/edit_blue.svg' width='23' height='20'> </a></td> 
			";?>
 
			<td><center> 
		
			<a href="delete_dep.php?id_dep=<?php echo $id_dep;?>" onclick="yuks(">
