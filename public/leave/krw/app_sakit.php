...
include "assets/configure/koneksi.php";  
 ...
 <!-- form -->	<center><h4>APROVAL FORM SAKIT</h4><br></center>
  <!-- Aprroval Cuti -->
            <div class="row"> 
...
<!-- Table  
   ...
   <link rel="stylesheet" href="csstable/css/bootstrap.min.css" /> -->
	 <!--<link rel="stylesheet" href="csstable/font-awesome/4.5.0/css/font-awesome.min.css" /> -->
	 <!--	<link rel="stylesheet" href="csstable/css/fonts.googleapis.com.css" />  -->
	 <!--	<link rel="stylesheet" href="csstable/css/ace.min.css" class="ace-main-stylesheet" id="main-ace-style" /> -->
	<!--	 <link rel="stylesheet" href="csstable/css/ace-skins.min.css" /> -->
	<!--  <link rel="stylesheet" href="csstable/css/ace-rtl.min.css" />  -->
...
$sql = " SELECT  `id_user`, `nama_lengkap`, `nik`, `hire_date`, `email`, `email2`, `username`, 
