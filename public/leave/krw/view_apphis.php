...
<?php include "assets/template/navbar.php"; ?>
 ...
 <?php  echo "<h5>View Approval History </h5><br>";?>
...
<script src="https://cdn.datatables.net/1.13.2/js/dataTables.bootstrap4.min.js"></script>
 ...
 <a href='view_app.php' > <button class="btn btn-success"> View App Request</button></a><br>
...
<?php   include "assets/configure/koneksi.php"; 
 ...
 `cuti_tahun`, `alasan`,doc_pendukung,`nik_sleader`, `status_sleader`, `tgl_appsleader`,
 ...
 WHERE status_approve1='1' or status_approve2='1' 
 
 GROUP BY id_trcuti ORDER BY tr_cuti.id_trcuti  DESC   ";
			...
			<td>
				<div class='dropdown'>
                      ...
                      <div class='dropdown-menu' aria-labelledby='dropdownMenuSizeButton2'>
                        ...
                        <div class='dropdown-divider'>	</div>                        
                        <a class='dropdown-item' href='#'>Sisa cuti:  $hitung_cuti </a>
						<div class='dropdown-divider'>	</div>                        
	...
	if ($app_hrgamng=='1'){
	  echo"<td>
		...
		echo"<td> <center><div class='badge badge-warning'>Waiting</div></td>"; 
		 	...
		 	if ($app_hrgas=='1'){
	 echo "<td>
		 <div class='badge badge-success'>$nm_hrgastaf</div> 
			 <br><font style='font-size:10px'>$tgl_apphrgas</font>		 
		 </td>";
		 }
	else {
