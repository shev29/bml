 ...
 <!-- Aprroval Cuti -->
           <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title mb-0">DATA SECTION</p>
...
///$query = "WHERE cuti_lahir.nik='$niks'"
 $sql = "SELECT  `id_section`, `kode_section`, `ket`, `ket2` FROM `section` ORDER BY id_section DESC";
...
$warnaHeading = "#FF0000";
  ...
  while($row = $result->fetch_assoc()) {
	...
	echo "<tr bgcolor='$warna'>
			...
			<td>$ket2 </td> 
			<td><center>
				<a href='edit_sec.php?id_section=$id_section'><img src='images/edit_blue.svg' width='23' height='20'></a>
			</td>";?>
 
			<td><center> 
			<a href="delete_sec.php?id_section=<?php echo $id_section;?>" onclick="confirm('Yakin akan di hapus!')">
