 ...
 <!-- form -->
           <div class="row"> 
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">LAHIR CUTI TAHUNAN MANUAL</h4>
 
                  <form class="forms-sample" method='post' action='post_lcutispv.php'>
				    <div class="form-group row">
                      <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Lahir Cuti Tanggal</label>
                      <div class="col-sm-5">
				...
				<div class="form-group row">
                 ...
                 <select name='nik' class="js-example-basic-multiple w-100">                     			 
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-5">
                        <input type="text" name='total' value='12' class="form-control" id="exampleInputEmail2">
                      </div>
                    </div> 
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                    <input type="reset" value="Reset"class="btn btn-primary mr-2"><button type="submit" class="btn btn-primary mr-2">Submit</button>
                      </div>
                    </div> 
