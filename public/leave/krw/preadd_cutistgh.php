...
include "assets/configure/koneksi.php";  
 ...
 <div class="row">
 <!-- form -->	<center><h4>FORM PENGAJUAN CUTI SETENGAH HARI</h4><br></center>

            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <form class="forms-sample" method='post' action='post_csetengah.php'>
				...
				<?php
					...
					include "assets/configure/koneksi.php";  
					 $sql = "SELECT `id_ctahunan`,cuti_lahir.kode_jcuti, `nik`,nama_cuti, `tahun`, `jumlah`,
						`lahir_cuti`, `exp_cuti`
...
if ($result_appz->num_rows > 0) {
 ...
 ?>
				...
				<input type="date" name='detail_tanggal' value='' class="form-control"  >

				</div><br>
				 <div class="form-group row">
                      <label for="exampleInputMobile" class="col-sm-3 col-form-label">Total Hari</label>
                      <div class="col-sm-5">  
					 <input type='nama_tlchecker'name='total_hari' size='5' readonly value='0.5' class='form-control'  >  
                      </div>
                    </div>
                ...
                <div class="card-body">  
                    ...
                    Dengan ini mohon untuk tidak masuk kerja karena:
					 ...
					 <div class="form-group">
                      ...
                      <textarea placeholder='Harap mencantumkan jam pulang' class="form-control" id="exampleTextarea1" name='alasan'rows="4"></textarea>
                    </div>
