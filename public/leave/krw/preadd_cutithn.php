...
include "assets/configure/koneksi.php";  
 ...
 <div class="row">
 <!-- form --> <h4>FORM PENGAJUAN CUTI TAHUNAN </h4><br> 
                ...
                <div class="card-body">
					...
					if ($result3->num_rows > 0) {
					 ...
					 ?>
                        ...
                        <input type="hidden" name='nm_lengkap' value='<?php  echo $nama_lengkap;?>' Readonly class="form-control" id="exampleInputUsername2" > 
						
                  
                     
                     
                        <input type="hidden" name='niks' value='<?php  echo $nik;?>' Readonly class="form-control" id="exampleInputUsername2" > 
...
//var_dump($sql);
					if ($result->num_rows > 0) {
					 ...
					 // echo "<option value='$id_dep'>$nmt_new [$ket]</option>";
					   ...
					   <input type='hidden' class='form-control' readonly value='$nmt_new [$kode_dep]'>";
					...
					if ($result->num_rows > 0) {
					  ...
					  echo "<input type='hidden' name='kode_loc' value='$kode_loc'><input type='hidden' class='form-control' readonly value='[$alias] $nama_loc'>";
					  }
					} else {
					  //echo "0 results";
					}
				...
				<div class="col-sm-5">
				<input type="hidden" name='hire_date' value='<?php  echo $hire_date;?>' Readonly class="form-control" id="exampleInputUsername2" >
				</div> 
				</div>
...
if ($result_appz->num_rows > 0) {
 ...
 <table border='0' size='100%'>
	<tr>
		<td><img src='assets/images/userkrw.png' width='100' height='100'></td>
		<td>
		<h3>Approval</h3><b>Shift Leader</b>&nbsp;&nbsp;:<?php  echo $nama_tlchecker;?> 
		<br><b>Check By</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<br> <?php  echo $nama_check1;?>/ <?php  echo $check_2;?>
		<br><b>Approve By</b>&nbsp;&nbsp;:<br>&nbsp;<?php echo $nama_approve1;?> / <?php echo $nama_approve2;?>
		 </td> 
		<td> </td> 
		<td> </td> 
	</tr>
	<tr>
		<td><label class="badge badge-danger"><?php  echo $nama_lengkap;?><br> <?php  echo $nik;?>  </label></td>
		<td><label class="badge badge-info">Join:<?php  echo $hire_date;?></label> </td> 
		<td> </td> 
		<td> </td>
	</tr>
 </table>
  ...
  <br> 
		<input type='hidden' name='nama' class='form-control' readonly value='<?php echo $nama_tlchecker;?>'> 
		<input type='hidden' name='tl_checker' class='form-control' readonly value='<?php echo $tl_checker;?>'>  
		<input type='hidden' class='form-control' readonly value='<?php echo $nama_tlchecker;?> / <?php echo $nama_check2;?>'> 
		...
		<input type='hidden' class='form-control' readonly value='<?php echo $nama_approve1;?> / <?php echo $nama_approve2;?>'> 
		...
		<input name='approve_2' type='hidden' class='form-control' readonly value='<?php echo $approve_2;?>'> 
				...
				<input type="text" name='detail_tanggal' value='' class="form-control date" placeholder="YYYY-MM-DD">

				</div><br>
				<label for="exampleTextarea1">Total</label>  <input type='text' name='total_hari' size='5' value='' readonly id='total'>  <label for="exampleTextarea1">Hari</label>
				...
				<div class="input-group">  
                    ...
                    </div><label class="form-check-label"> Alasan<br> </label>
