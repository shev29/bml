 ...
 <!-- Aprroval Cuti -->
           <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title mb-0">Ubah Permohonan Cuti</p>
                  <div class="table-responsive">
                     <table id="dynamic-table"  border="1" style='border: 1px solid #fff; font-family: sans-serif; color: #232323;  border-collapse: collapse;
                        ...
                        <tr style='background: #35A9DB;color:#fff;font-weight:normal;'>
                          ...
                          <th>&nbsp;&nbsp;&nbsp;Tanggal&nbsp;&nbsp;&nbsp;&nbsp;</th>
                          <th>&nbsp;<br>Nama&nbsp;Dokument&nbsp;<br>&nbsp;</th> 
                        </tr>  
                      </thead>
                      <tbody>
<?php
error_reporting(0);
 $sql = "SELECT `id_trcuti`, tr_cuti.nik, nama_lengkap, tr_cuti.kode_jcuti,nama_cuti,
 `tgl_pengajuan`, `tgl_awalc`, `tgl_akhir`, `detail_tanggal`,
 `total_hari`, `cuti_tahun`, `alasan`,	doc_pendukung, `approve_sleader`, `tgl_appsleader`,
...
$warnaHeading = "#FF0000";
  ...
  while($row = $result->fetch_assoc()) {
	  ...
	  $nik = $row['nik'];
	  $kode_jcuti1 = $row['kode_jcuti'];
	  $nama_cuti1 = $row['nama_cuti'];
	...
	echo "<tr bgcolor='$warna'>
			<td>$no</td>
			<td>$nmt_new</td><td><select>
			
			";
//SELECT `id_jcuti`, `kode_jcuti`, `nama_cuti`, `keterangan` FROM `jenis_cuti`			

$sql44 = "SELECT `id_jcuti`, `kode_jcuti`, `nama_cuti`, `keterangan` FROM `jenis_cuti` 
		  WHERE kode_jcuti!='$kode_jcuti1'";
$result44 = $conn->query($sql44);

if ($result44->num_rows > 0) {
  // output data of each row
  echo "<option ='$kode_jcuti1'>$nama_cuti1</option>";
  while($row44 = $result44->fetch_assoc()) {
	  $kode_jcuti = $row44['kode_jcuti'];
	  $nama_cuti = $row44['nama_cuti'];
     echo "<option ='$kode_jcuti'>$nama_cuti</option>";
  }
}  
			echo "</select></td><td>$alasan</td> 
			<td>$tgl_ajuan</td>  
			<td>$docs</td>
