...
include "assets/configure/koneksi.php";  
 ...
 <div class="row">
 <!-- form -->	<center><h4>FORM PENGAJUAN IZIN</h4><br></center>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method='post' action='post_izin.php'>
                     ...
                     <label for="exampleInputMobile" class="col-sm-3 col-form-label">Tahun</label>
					  ...
					  <?php
						  ...
						  echo "<input type='text' class='form-control' id='exampleInputUsername2' name='cuti_tahun' value='$now'>";
							?> 
                    </div>
                    </div>
                    <div class="form-group row">
...
<div class="container">
 ...
 <label for="exampleTextarea1">Total Izin</label>  <input type='text' name='total_hari' size='5' value='' id='total'>  <label for="exampleTextarea1">Hari</label>
