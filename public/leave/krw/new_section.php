            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method='post' action='post_section.php'>
                    <div class="form-group row">
                      <label for="exampleInputUsername2" class="col-sm-5 col-form-label">Nama&nbsp;Section</label>
                      <div class="col-sm-7">
                        <input type="text" name='kode_section' class="form-control" id="exampleInputUsername2" >
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Ket</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name='ket' id="exampleInputUsername2"  >
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Ket2</label>
                      <div class="col-sm-9">
                        <input type="text" name='ket2' class="form-control" id="exampleInputUsername2" >
                      </div>
                    </div>
