...
include "assets/configure/koneksi.php";  
 ...
 <div class="row">
 <!-- form -->	<center><h4>FORM PENGAJUAN CUTI NORMATIF</h4><br></center>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method='post' enctype="multipart/form-data"  action='post_cnormatif.php'>
				     ...
				     <div class="form-group"> 
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                              <input type="radio" class="form-check-input" name="ct" id="optionsRadios2" value="Karyawan Menikah (3 Hari)" >
                              Karyawan Menikah (3 Hari)
                            </label>
                         </div>
						<div class="form-check">
                            <label class="form-check-label">
                              <input type="radio" class="form-check-input" name="ct" id="optionsRadios2" value="Penikahan anak karyawan (2 Hari)" >
                              Penikahan anak karyawan (2 Hari)
                            </label>
                          </div>
                        <div class="form-check">
                            <label class="form-check-label">
                              <input type="radio" class="form-check-input" name="ct" id="optionsRadios2" value="Khitanan/Baptis anak karaywan (2 Hari)" >
                              Khitanan/Baptis anak karaywan (2 Hari)
                            </label>
                         </div>
			 
						<div class="form-check">
                            <label class="form-check-label">
                              <input type="radio" class="form-check-input" name="ct" id="optionsRadios2" value="Istri karyawan melahirkan atau keguguran (2 Hari)" >
						...
						<div class="form-check">
                            <label class="form-check-label">
                              <input type="radio" class="form-check-input" name="ct" id="optionsRadios2" value="Suami/Istri/Orang Tua/Mertua/Anak/Menantu meninggal dunia (2 Hari)" >
                             Suami/Istri/Orang Tua/Mertua/Anak/Menantu meninggal dunia (2 Hari)
                            </label>
                          </div>
						<div class="form-check">
                            <label class="form-check-label">
                              <input type="radio" class="form-check-input" name="ct" id="optionsRadios2" value="Anggota keluarga dalam satu rumah meninggal dunia (1 Hari)" >
...
<div class="container">
 ...
 <label for="exampleTextarea1">Total</label>  <input type='text' name='total_hari' size='5' value='' id='total'>  <label for="exampleTextarea1">Hari</label>
