...
<?php include "assets/template/navbar.php"; ?>
 ...
 <!-- Aprroval Cuti -->
                  ...
                  <p class="card-title mb-0">Approval List </p>
...
<?php
 ...
 tr_cuti.ket, tr_cuti.ket2, user.level, user.kode_loc, user.kode_section FROM `tr_cuti` 
...
// manager
	...
	echo "<tr bgcolor='$warna'>
		 ...
		 if ($kode_loc=='KARAWANG FC1' or $kode_loc=='KARAWANG FC2'){	 
			...
			?>
				 <td><a href="approve_cuti.php?id=<?php echo $id_trcuti; ?>" ><div class='badge badge-warning'>Approve</div></a>
				  <p style="font-size:10px"><?php  echo $tgl_appsleader; ?></p>
				</td> 
			<?php }
		}
		...
		<?php	}
				...
				elseif($leveled=='SPV'){
					if($level!="MANAGER"){
						...
						<td>
						<div class="badge badge-success">Approved</div>
						<p style="font-size:10px"><?php  echo $tgl_appspv; ?></p>
						</td> 
					<?php  }
						...
						?>
						 <td>
						<a href="approve_spv.php?id=<?php echo $id_trcuti; ?>" ><div class='badge badge-warning'>Approve</div></a>
		...
		<?php 	  }
				   ...
				   <td>
				<a href="approve_mng.php?id=<?php echo $id_trcuti; ?>" ><div class='badge badge-warning'>Approve</div></a>
