...
(select nama_lengkap from user where nik=approve_2 GROUP by id_user) as nm_app2
        FROM `app_level`
  ...
  ?>
                  <form class="forms-sample" method='post' action='update_appmaster.php'>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value='<?php echo $nm_tl_checker1; ?>' class="form-control" name='tl_checker' id="exampleInputUsername2"  >
                      </div>
                    </div>
                    <div class="form-group row">
