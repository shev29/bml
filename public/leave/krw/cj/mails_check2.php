...
(select email from user where nik=check_2)as email_c1,
(select email2 from user where nik=check_2)as email_c2,
...
/*	$mail->addAddress("dudi.ramdani@hts-bml.co.id",""); //email SPV 
	...
	$bodys.="<tr><td colspan='3'>Dear $nm_check2 sebagai Approver 1</td></tr> 
