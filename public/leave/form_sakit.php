...
include "assets/configure/koneksi.php";  
 ...
 <!-- form -->	<center><h4>FORM SAKIT</h4><br></center>
           <div class="row"> 
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method='post' enctype="multipart/form-data"  action='post_fsakit.php'>
 ...
 <!-- satu colom form -->
             <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">  
                    ...
                    Dengan ini mohon untuk tidak masuk kerja karena Sakit:
                  </p>  
                    </div> 
				<div class="form-group row">
			...
			<label for="exampleTextarea1">Total</label>  <input type='text' name='total_hari' size='5' value='' id='total'>  <label for="exampleTextarea1">Hari</label>
                    <hr>  <div class="form-group row">
                     <label for="exampleInputMobile" class="col-sm-3 col-form-label"><br>Keterangan / Diagnosa Umum:</label>
                      <div class="col-sm-9">
                       </div>
 
                     <div class="col-sm-9">
                        <br><input type="text" name='ct' value='Sakit'   class="form-control" id="exampleInputUsername2" >
                      </div>
                    </div><hr>
