...
<script src="https://cdn.datatables.net/1.13.2/js/dataTables.bootstrap4.min.js"></script>
 <a href='track_cuti.php'<button>Tracking Cuti</button></a>
...
<?php   include "assets/configure/koneksi.php"; 
 ...
 `tgl_awalc`, `tgl_akhir`, `detail_tanggal`, `total_hari`, `cuti_tahun`, `alasan`,`alasan`, `nik_sleader`, `status_sleader`, `tgl_appsleader`, `nik_check1`,
