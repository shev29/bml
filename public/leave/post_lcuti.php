...
$thn_ambil = date("Y", strtotime($tgllahir_cuti)); 
 ...
 $sql = "INSERT INTO `cuti_lahir` (`id_ctahunan`, `kode_jcuti`, `nik`, `tahun`, `jumlah`, `lahir_cuti`, `exp_cuti`, `tag`, ket, sequence) 
 VALUES (NULL, 'CT12', '$nik', '$thn_ambil', '$total', '$tgl_lcuti', '$effectiveDate', '12', '$ket', '$thn_ambil$nik')";
 //var_dump($sql);
