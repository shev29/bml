...
?>
           ...
           <div class="row"> 
<a href='view_apphis.php' > <button class="btn btn-success"> View App History</button></a>
...
if($leveled=="OFFICER"){
$shorthrga ="And  app_hrgas<>'1'";
}
elseif ($leveled=="SPV"){
$shorthrga ="And  app_hrgaspv<>'1'";    
}
elseif ($leveled=="MANAGER"){
$shorthrga ="And  app_hrgamng<>'1'";    
}
else{
$shorthrga="";    
}
