            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method='post' action='post_location.php'>
                    <div class="form-group row">
                      <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Kode Loc</label>
                      <div class="col-sm-9">
                        <input type="text" name='kode_loc' class="form-control" id="exampleInputUsername2"  >
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Nama Loc</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name='nama_loc' id="exampleInputUsername2"  >
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Alias</label>
                      <div class="col-sm-9">
                        <input type="text" name='alias' class="form-control" id="exampleInputUsername2" >
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        ...
                        <input type="text" name='alamat' class="form-control" id="exampleInputMobile" > 
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name='ket' class="form-control" id="exampleInputPassword2"  >
                      </div>
                    </div>    
