...
$sql = " SELECT  `id_user`, `nama_lengkap`, `nik`, `hire_date`, `email`, `email2`, `username`, `password`, 
		 location.kode_loc,alias,location.nama_loc,  user.kode_dep,department.nama_dep, user.kode_section, `level`, `level_akses`,  `token`, `exp_token`, `status_aktif`
		FROM `user` 
		INNER JOIN location	ON user.kode_loc = location.alias
		INNER JOIN department ON user.kode_dep = department.kode_dep
		LEFT JOIN section ON user.kode_section = section.kode_section
                ...
                <div class="card-body">
                 ...
                 <!--   <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                    <button type="button" class="btn btn-light">Cancel</button><button type="submit" class="btn btn-primary mr-2">Submit</button>
                      </div>
                    </div> 
