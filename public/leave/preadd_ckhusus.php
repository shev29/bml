...
include "assets/configure/koneksi.php";  
 ...
 <div class="row">
 <!-- form -->	<center><h4>FORM PENGAJUAN CUTI KHUSUS </h4><br></center>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
				...
				<input name='cuti_tahun' value='' class="form-control"> 
                      </div>
                      </div>
                    </div>
                    <div class="form-group row">
...
if ($result_appz->num_rows > 0) {
 ...
 ?>
				...
				<div class="form-group row">
					 ...
					 <input type='text' class='form-control' readonly value='MAILINDA'> 
					 <input type='hidden' name='check_1'class='form-control' readonly value='100000003'> 
					 <input type='hidden' name='check_2'class='form-control' readonly value='100000003'> 
				...
				<div class="form-group row">
					 ...
					 <input type='text' class='form-control' readonly value='MAILINDA'> 
					 <input name='approve_1' type='hidden' class='form-control' readonly value='100000003'>  
					 <input name='approve_2' type='hidden' class='form-control' readonly value='100000003'> 
