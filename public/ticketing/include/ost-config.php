...
define('SECRET_SALT','0BBeyvo2oBJ=Za5rTA8goQN2idKmlnxr');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','nugroho@logisteed.com');
...
define('DBHOST','bmldev.logisteed.id');
define('DBNAME','bml_osticket');
define('DBUSER','bmldev');
define('DBPASS','G5S1LMQ4VHQ1');
