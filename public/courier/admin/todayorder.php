...
$sql = "SELECT `no_order`, `type_order`, `nama_barang`, `job_refnumber`, (courierm_alamat.dtl_alamat) as alamat_asal, idalamat_asal,idalamat_tujuan,
		...
		WHERE     datetime_proses BETWEEN '$tgl_kemarin1 00:00:00' and '$nowdate_forexpire 23:59:59'
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
		...
		include "../assets/configure/koneksi.php";
		$sql2 = "SELECT  nik, nama_lengkap FROM `user` WHERE courier_akses='kurir' order by id_user DESC";
