  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <h2 class="text-center display-4"><img src='../img/logo2.jpg' width='60' height='40'>Manage Order</h2>
      </div>
    </section>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8 offset-md-2">
					...
					<input type="search" class="form-control form-control-lg" name='cari' placeholder="Input Resi you want to delete here..." value="">
...
$sql = "SELECT `no_order`, `type_order`, `nama_barang`, `job_refnumber`, (courierm_alamat.dtl_alamat) as alamat_asal, nama_perusahaan,
				...
				`nik_kurir`,nik_user,nama_lengkap, `status`, tr_pengiriman.ket1, tr_pengiriman.ket2, `aktif`,gambar 
		FROM `tr_pengiriman` 
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
			...
			$delete = "<a href='delete_order.php?no_order=$no_order&&nikp=$nik_user'>
...
/* 			
  ...
  echo "
                    ...
                    <div class='list-group'>
                        <tr><td><p class='text-danger'>No item found with Resi ($cari)</p></td></tr>
                            </div>
                        </div> 
