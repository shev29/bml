...
<?php include "../assets/vendor/menu_user/sidebar.php"; ?>
  ...
  <form method='post' action='posti_pickup.php'>
  ...
  <!-- general form elements -->
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">ADDITIONAL PICK UP FORM </h3>
              </div> 
			 ...
			 <div class="form-group">
				...
				<div class="alert alert-warning alert-dismissible"> 
				  ...
				  <table>
					<tr>
						<td> 		<input class="form-check-input" type="hidden" name="nikso" value="<?php echo $nikso?>">
...
<?php
    ...
    ?>
     <input type="date" name="date_proses" maxlength='26' size='4' readonly class="form-control" value='<?php echo $nextday;?>' placeholder=" ...">
      <input type="time" name="time_proses" maxlength='26' size='4' class="form-control" placeholder=" ...">
    <?php
}
?>
...
<?php
	...
	<input type='button' name='idalamat_asal' value='Show Detail' id='but_read'>
		...
		<div class="form-group">
			<label for="exampleInputEmail1">Alamat Tujuan</label><br>
			 <!-- Dropdown -->       
