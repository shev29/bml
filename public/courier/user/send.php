...
<?php include "../assets/vendor/menu_user/navbar.php";?>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Courier System</span>
    </a>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">SEND	FORM </h3>
              </div> 
  <?php 
  ...
  <img src='images/additonal.png'></center>";
    ...
    ?>
			 ...
			 <div class="form-group">
				<label for="exampleInputEmail1">Order From (Sender)</label><br>
				<div class="alert alert-warning alert-dismissible">
				
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button> 
				  <table>
					<tr><input class="form-check-input" type="hidden" name="nikso" value="<?php echo $nikso;?>">
			 ...
			 <div class="form-group">
 			 ...
 			 <div class="form-group">
				...
				<div class="alert alert-warning alert-dismissible">  
                 <input type="text" name="penerima" class="form-control" placeholder="PIC/Tempat pengambilan ...">
                </div>
			</div>	
...
<?php
		...
		$('#result2').html("Detail : " + username);
		 ...
		 <div class="form-group">
				<label style='color: white;'>Note</label><br> 
                 <input type="hidden" name="ket" class="form-control" value="" placeholder="">
