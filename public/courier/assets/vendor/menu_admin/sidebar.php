...
/* 				$home = $_GET['home'];
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="mydelivery.php" class="nav-link <?php echo $aktif; ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>My Delivery</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="additional_order.php" class="nav-link">
              <i class="nav-icon far fa-circle text-danger"></i>
              <p class="text">Additional Order</p>
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="deleted_order.php" class="nav-link">
              <i class="nav-icon far fa-circle text-danger"></i>
              <p class="text">Deleted History</p>
            </a>
          </li>
