        ...
        <div class="row">
          ...
          <section class="col-lg-7 connectedSortable">
            ...
            <!-- /.card -->
			  ...
			  <form method='post' action='save_dsend.php' enctype="multipart/form-data"> 
				...
				echo "<tr>
					 ...
					 <td>  
						...
						<div class='widget-main'>  
							<input name='now_resi' type='hidden' value='$no_order'  />  
</div>							
					 </td>  
					 <td>  
...
<tr><td colspan='2'>
    <input type='submit' name='upload' class="btn btn-block btn-primary btn-sm" value='Selesai Send'>                 
</td></tr> 
</form>
