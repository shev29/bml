          ...
          <div class="col-12"> 
            <div class="card"> 
              ...
              <div class="card-body">
				 ...
				 <form method='post' action='singlepost_kurir.php'>
...
$sql = "SELECT `no_order`, `type_order`, `nama_barang`, `job_refnumber`, gambal_ambil, gambal_kirim, (courierm_alamat.dtl_alamat) as alamat_asal, nama_perusahaan,
		...
		WHERE tr_pengiriman.nik_kurir='$nikkur'
  ...
  while($row = $result->fetch_assoc()) {
			...
			elseif(!empty($status=="Transfer")){
				...
				echo "<tr>
                    ...
                    <td>$type_order <img src='../doc_pendukung/$gambal_ambil' width='40' height='40'><img src='../doc_pendukung/$gambal_kirim'width='40' height='40'></td>					
                    <td>$nama_lengkap </td>
