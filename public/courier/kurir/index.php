          ...
          <section class="col-lg-7 connectedSortable">
            ...
            <!-- /.card -->
              ...
              <div class="card-body p-0">
				...
				<form action='post_kpickup.php' method='post'>   
                <table id="example1" border='0'class="table m-0">
                
                  <tr>
					<td>NoUrut</td> 
                    <td>Alamat&nbsp;Asal&nbsp;-&nbsp;Tujuan&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>  
                  </tr>
                  <tr>	<td>
				  <input type='submit' class="btn btn-block btn-primary btn-sm" value='Simpan'>
						</td> 
						<td></td> 
                  </tr> 
                  <tbody>
...
// echo "$nikkur";
		...
		$sql = "SELECT `no_order`, `type_order`, `nama_barang`, `job_refnumber`, (courierm_alamat.dtl_alamat) as alamat_asal,  
				...
				`nik_kurir`, `status`, tr_pengiriman.ket1, tr_pengiriman.ket2, `aktif`,sequence 
		FROM `tr_pengiriman` 
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
			...
			elseif(!empty($status=="Transfer")){
			  ...
			  //<img src='../img/information.png' alt='Some Image' height='20' width='20'/>
				echo "<tr>
                    <td>"; 
								
			if($sequence_pickup=='0'){
				
				echo" <input type='hidden' name='resi[]' value='$no_order'>"; 
					echo"<div class='widget-main'>  
					<input name='seq[]' class='form-control form-control-sm'  size='1' type='number' value='' id='spinner$no' />  
				</div>";
							}
			else{
			echo $sequence_pickup;
			}						
		 ...
		 echo"</td><td>";
			...
			echo "<div class='color-palette-set'> 
			 ...
			 <div class='bg-warning color-palette'><span><b>Dari :$pt_asal</b></span></div>
			 
			  <div class='tooltip-content'>
			   $pt_asal ($pengirim)&nbsp;&nbsp;&nbsp;$alamat_asal
			  </div> 
			</div> <br>
			 <div class='tooltip-wrap'>
			 <div class='bg-warning disabled color-palette'><span><b>Tujuan: $pt_tujuan</b></span></div>
			 
			  <div class='tooltip-content'>
			   $pt_tujuan ($penerima)&nbsp;&nbsp;&nbsp;$alamat_tujuan
			  </div> 
			</div>				
			</div> 
			</td> 
...
?>              
              ...
              <div class="card-body p-0">
				...
				<form action='post_ksend.php' method='post'>  
			    <table id="example1" border='0'class="table m-0">
                  <thead>
                  <tr>
					<th>Urutan</th> 
				  ...
				  <td> <input type='submit' class="btn btn-block btn-primary btn-sm" value='Simpan'>
                  </td>
				 </thead>
						  <tbody>
		 <?php
		...
		if ($result->num_rows > 0) {
		  ...
		  while($row = $result->fetch_assoc()) {
					...
					$no ++;
					$no_ordersend = $row['no_order'];
					$pt_tujuansend = $row['pt_tujuan'];
					$pt_asalsend = $row['pt_asal'];
					$pengirimsend = $row['pengirim'];
					$penerimasend = $row['penerima']; 
					$nik_kur = $row['nik_kurir']; 
					$type_order = $row['type_order'];
					$sequence_send = $row['sequence'];
					if($type_order=="Pickup"){
						$show_type="<button type='submit' class='btn btn-block btn-success btn-sm'> 
						    Pickup
						</button>";
					...
					$alamat_asalsend = $row['alamat_asal'];
					$alamat_tujuansend = $row['alamat_tujuan'];
					$nama_barang = $row['nama_barang'];
					//$idalamat_asal = $row['idalamat_asal'];
					//$idalamat_tujuan = $row['idalamat_tujuan'];
					$job_refnumber = $row['job_refnumber'];
				...
				echo" <input type='hidden' name='resi[]' value='$no_ordersend'>"; 
					echo"<div class='widget-main'>  
					<input name='seq[]' class='form-control form-control-sm'  size='1' type='number' value='' id='spinner$no' />  
				</div>";
							}
			...
			echo "<div class='color-palette-set'> 
			 <div class='tooltip-wrap'>
			 <div class='bg-warning color-palette'><span><b>Dari :$pt_asalsend</b></span></div>
			 
			  <div class='tooltip-content'>
			   $pt_asalsend ($pengirimsend)&nbsp;&nbsp;&nbsp;$alamat_asal
			  </div> 
			</div> <br>
			 <div class='tooltip-wrap'>
			 <div class='bg-warning disabled color-palette'><span><b>Tujuan: $pt_tujuansend</b></span></div>
			 
			  <div class='tooltip-content'>
			   $pt_tujuansend ($penerimasend)&nbsp;&nbsp;&nbsp;$alamat_tujuansend
			  </div> 
			</div>				
			</div> 
			</td> ";
	...
	/* 						echo"<td>     
								  <button type='button' class='btn btn-block btn-outline-dark btn-xs'>
								  <p style='font-size:70%;'>$pt_asal ($pengirim )&nbsp;&nbsp;&nbsp;$alamat_asal</p> </button>
									 
								  <button type='button' class='btn btn-block btn-outline-dark btn-xs' > 
								  
								  <p style='font-size:70%;'>ke:
								  <span class='badge badge-warning'><font size='1'> $pt_tujuansend </font></span> ($penerima )  $alamat_tujuan</p></button>  
 
							</td>";  */
							 
						  echo"</tr>"; //$alamat_asal $alamat_tujuan
		  }
		}  
...
<script type="text/javascript">
			jQuery(function($) {
				...
				.on('changed.fu.spinbox', function(){
				 ...
				 $('#spinner20').ace_spinner({value:1,min:1,max:20,step:1, on_sides: true, icon_up:'ace-icon fa fa-plus bigger-110', icon_down:'ace-icon fa fa-minus bigger-110', btn_up_class:'btn-success' , btn_down_class:'btn-danger'});
				 $('#spinner21').ace_spinner({value:1,min:1,max:20,step:1, on_sides: true, icon_up:'ace-icon fa fa-plus bigger-110', icon_down:'ace-icon fa fa-minus bigger-110', btn_up_class:'btn-success' , btn_down_class:'btn-danger'});
				 $('#spinner22').ace_spinner({value:1,min:1,max:20,step:1, on_sides: true, icon_up:'ace-icon fa fa-plus bigger-110', icon_down:'ace-icon fa fa-minus bigger-110', btn_up_class:'btn-success' , btn_down_class:'btn-danger'});
				 $('#spinner23').ace_spinner({value:1,min:1,max:20,step:1, on_sides: true, icon_up:'ace-icon fa fa-plus bigger-110', icon_down:'ace-icon fa fa-minus bigger-110', btn_up_class:'btn-success' , btn_down_class:'btn-danger'});
				 $('#spinner24').ace_spinner({value:1,min:1,max:20,step:1, on_sides: true, icon_up:'ace-icon fa fa-plus bigger-110', icon_down:'ace-icon fa fa-minus bigger-110', btn_up_class:'btn-success' , btn_down_class:'btn-danger'});
				 $('#spinner25').ace_spinner({value:1,min:1,max:20,step:1, on_sides: true, icon_up:'ace-icon fa fa-plus bigger-110', icon_down:'ace-icon fa fa-minus bigger-110', btn_up_class:'btn-success' , btn_down_class:'btn-danger'});
				 $('#spinner26').ace_spinner({value:1,min:1,max:20,step:1, on_sides: true, icon_up:'ace-icon fa fa-plus bigger-110', icon_down:'ace-icon fa fa-minus bigger-110', btn_up_class:'btn-success' , btn_down_class:'btn-danger'});
				 $('#spinner27').ace_spinner({value:1,min:1,max:20,step:1, on_sides: true, icon_up:'ace-icon fa fa-plus bigger-110', icon_down:'ace-icon fa fa-minus bigger-110', btn_up_class:'btn-success' , btn_down_class:'btn-danger'});
				 $('#spinner28').ace_spinner({value:1,min:1,max:20,step:1, on_sides: true, icon_up:'ace-icon fa fa-plus bigger-110', icon_down:'ace-icon fa fa-minus bigger-110', btn_up_class:'btn-success' , btn_down_class:'btn-danger'});
				 $('#spinner29').ace_spinner({value:1,min:1,max:20,step:1, on_sides: true, icon_up:'ace-icon fa fa-plus bigger-110', icon_down:'ace-icon fa fa-minus bigger-110', btn_up_class:'btn-success' , btn_down_class:'btn-danger'});
				 $('#spinner30').ace_spinner({value:1,min:1,max:20,step:1, on_sides: true, icon_up:'ace-icon fa fa-plus bigger-110', icon_down:'ace-icon fa fa-minus bigger-110', btn_up_class:'btn-success' , btn_down_class:'btn-danger'});
				 $('#spinner31').ace_spinner({value:1,min:1,max:20,step:1, on_sides: true, icon_up:'ace-icon fa fa-plus bigger-110', icon_down:'ace-icon fa fa-minus bigger-110', btn_up_class:'btn-success' , btn_down_class:'btn-danger'});
				 $('#spinner32').ace_spinner({value:1,min:1,max:20,step:1, on_sides: true, icon_up:'ace-icon fa fa-plus bigger-110', icon_down:'ace-icon fa fa-minus bigger-110', btn_up_class:'btn-success' , btn_down_class:'btn-danger'});
				 $('#spinner33').ace_spinner({value:1,min:1,max:20,step:1, on_sides: true, icon_up:'ace-icon fa fa-plus bigger-110', icon_down:'ace-icon fa fa-minus bigger-110', btn_up_class:'btn-success' , btn_down_class:'btn-danger'});
				 $('#spinner34').ace_spinner({value:1,min:1,max:20,step:1, on_sides: true, icon_up:'ace-icon fa fa-plus bigger-110', icon_down:'ace-icon fa fa-minus bigger-110', btn_up_class:'btn-success' , btn_down_class:'btn-danger'});
				 $('#spinner35').ace_spinner({value:1,min:1,max:20,step:1, on_sides: true, icon_up:'ace-icon fa fa-plus bigger-110', icon_down:'ace-icon fa fa-minus bigger-110', btn_up_class:'btn-success' , btn_down_class:'btn-danger'});
				 $('#spinner36').ace_spinner({value:1,min:1,max:20,step:1, on_sides: true, icon_up:'ace-icon fa fa-plus bigger-110', icon_down:'ace-icon fa fa-minus bigger-110', btn_up_class:'btn-success' , btn_down_class:'btn-danger'});
				 $('#spinner37').ace_spinner({value:1,min:1,max:20,step:1, on_sides: true, icon_up:'ace-icon fa fa-plus bigger-110', icon_down:'ace-icon fa fa-minus bigger-110', btn_up_class:'btn-success' , btn_down_class:'btn-danger'});
