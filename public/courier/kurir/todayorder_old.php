			...
			elseif(!empty($status=="Transfer")){
				...
				echo "<tr>
					...
					<input type='hidden' name='resi' value='$no_order'>  
					 <a href='finish_pickup.php?resi=$no_order'> <button type='submit' class='btn btn-block btn-success btn-sm'> 
                  Delivery Pickup
                </button></a>
					 </td>
					 <td>  
		  ...
		  while($row = $result->fetch_assoc()) {
					...
					elseif(!empty($status=="Transfer")){
						...
						echo "<tr>
							<td> 
							<input type='hidden' name='resi' value='$no_order'>  
							 <a href='finish_send.php?resi=$no_order'><button type='submit' class='btn btn-block btn-info btn-sm'> 
						  Delivery Send
						</button></a>
							 </td>
							 <td>
