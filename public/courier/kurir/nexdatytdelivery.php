                  ...
                  <tr>
                   ...
                   <tbody>
                    ...
                    $sql = "SELECT `no_order`, `type_order`, `nama_barang`, `job_refnumber`, (courierm_alamat.dtl_alamat) as alamat_asal,  
                    		...
                    		WHERE type_order='Pickup' AND nik_kurir='$nikkur'   
                   ...
                   ///var_dump($sql);
                    if ($result->num_rows > 0) {
                      ...
                      while($row = $result->fetch_assoc()) {
                    			...
                    			$ket2 = $row['ket2'];      
                    			if ($status==='Delivered'){
                    			    $tag_move ="<span class='badge badge-success'>Delivered</span>";
                    			    $tag_cancel="";
                    			} 
                    			...
                    			elseif(!empty($status=="Transfer")){
                    				...
                    				echo "<tr>
                    					...
                    					$tag_cancel
                    					 ...
                    					 <p style='font-size:70%;'>($no_order)$nama_barang - $datetime_proses</p> 						
                    							$tag
                    						</div> 
                    					 </td>
                                        <td> 
                    ...
                    $sql = "SELECT `no_order`, `type_order`, `nama_barang`, `job_refnumber`, (courierm_alamat.dtl_alamat) as alamat_asal,  
                    		...
                    		FROM `tr_pengiriman` 
                    		INNER JOIN courierm_alamat ON tr_pengiriman.idalamat_asal = courierm_alamat.id_alamat
                    		WHERE type_order='Send' AND nik_kurir='$nikkur'   
                    		  ...
                    		  while($row = $result->fetch_assoc()) {
                    			    ...
                    			    elseif(!empty($status==="Waiting Courier")){
                    					...
                    					$tag_cancel
                    							 ...
                    							 <td>
                    								<div class='widget-main'>    
                    							 <p style='font-size:70%;'>($no_order)$nama_barang  <br>
                    									$tag $datetime_proses </p> 
                    								</div> 
                    							 </td>
                    							<td> 
                    							 <div class='btn-group'><p style='font-size:70%;'> $pt_asal ($pengirim )  </p>  
