        ...
        <div class="row">
          ...
          <section class="col-lg-7 connectedSortable">
            ...
            <!-- /.card -->
			  ...
			  <form method='post' action='uploadulang.php' enctype="multipart/form-data"> 
...
?> 
<tr><td colspan='2'>
<input type='submit' name='upload' class="btn btn-block btn-primary btn-sm" value='Foto Ulang'>               
</td></tr> 
