        ...
        <div class="row">
          ...
          <section class="col-lg-7 connectedSortable">
            ...
            <!-- /.card -->
			  ...
			  <form method='post' action='save_dpickup.php' enctype="multipart/form-data"> 
				...
				echo "<tr>
					 ...
					 <td>  
						...
						<div class='widget-main'>  
							<input name='now_resi' type='hidden' value='$_GET[resi]'  />  
</div>							
					 </td>  
					 <td>  
...
<tr><td colspan='2'>
<input type='submit' name='upload' class="btn btn-block btn-primary btn-sm" value='Selesai Pickup'>               
</td></tr> 
